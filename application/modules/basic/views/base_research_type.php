						...
						<!-- Single button -->
							<div class="btn-group">
							  ...
							  <ul class="dropdown-menu">
							    ...
							    <li><a href="<?=base_url('basic/del/'.$this->router->fetch_method())?>/<?=$item->id?>" class="text-red" onclick="return confirm('ยืนยันการลบรายการ: <?=$item->research_type?>?')"><span class="fa fa-remove fa-fw"></span>ลบ</a></li>
							  </ul>
							</div>
					</td>
				</tr>
