<?php if(!empty($Basic_items)):?>
	<table class="table table-hover tb-basic">
		<thead>
			<th>#ID</th>
			<th>หัวข้อการวิจัย</th>
			<th>ประเภทของงานวิจัย</th>
			<th>การจัดการ</th>
		</thead>
		<tbody>
						...
						<!-- Single button -->
							<div class="btn-group">
							  ...
							  <ul class="dropdown-menu">
							    ...
							    <li><a href="<?=base_url('basic/del/'.$this->router->fetch_method())?>/<?=$item->id?>" class="text-red" onclick="return confirm('ยืนยันการลบรายการ: <?=$item->topic?>?')"><span class="fa fa-remove fa-fw"></span>ลบ</a></li>
							  </ul>
							</div>
					</td>
				</tr>
