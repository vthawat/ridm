<form method="post" class="form-horizontal country-fillter" action="<?=base_url('trader/production/fillter')?>">
	...
	<div class="form-group">
		 <label for="product_type" class="col-sm-3 control-label">ประเภทผลิตภัณฑ์</label>
		 <div class="col-sm-9">
		 	<select class="form-control" id="product_type" name="product_type_id">
		 		<option value="">--เลือกประเภทผลิตภัณฑ์--</option>
		 		<?php foreach($product_type_fillter as $item):?>
		 			<?php if($this->input->get_post('product_type_id')==$item->id):?>
